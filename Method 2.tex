...
where $\sigma_\text{ref}$ is the reference time resolution and $\sigma$ is the time resolution of the individual scintillator detector under investigation. All CTR values in this paper are given in picoseconds.
