...
where $\sigma_\textrm{measured}$ is the measured time resolution and $\sigma_\text{ref}$ is the reference time resolution. All CTR values in this paper are given in picoseconds.
